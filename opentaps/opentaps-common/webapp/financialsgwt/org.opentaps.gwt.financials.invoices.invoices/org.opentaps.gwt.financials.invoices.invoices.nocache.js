function org_opentaps_gwt_financials_invoices_invoices(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers(['es', 'opera'], '2080C9CDC8C40BBAC3552F37FB29DCC6');
      unflattenKeylistIntoAnswers(['nl', 'gecko1_8'], '23F7ED3A1938072D3930746392C72747');
      unflattenKeylistIntoAnswers(['es', 'gecko'], '25CA9AFB1F37806C965D973AEFBF4B3E');
      unflattenKeylistIntoAnswers(['default', 'safari'], '2938D3518BE55CD2F30C004343A28DCF');
      unflattenKeylistIntoAnswers(['es', 'ie6'], '2DEF8DDC2B0DBEF7AFF8A779D0FA8EA1');
      ...
      unflattenKeylistIntoAnswers(['es', 'gecko1_8'], '74DE3EB50C737340E8680EC8864294F8');
      ...
      unflattenKeylistIntoAnswers(['es', 'safari'], 'CE7E5BC807852BF007E33A438F38F2C7');
