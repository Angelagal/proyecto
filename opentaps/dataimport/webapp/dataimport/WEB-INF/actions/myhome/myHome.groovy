...
facturasProcessed = delegator.findCountByCondition("DataImportFacturas", allConditions, null);
...
facturasNotProcessed = delegator.findCountByCondition("DataImportFacturas", statusCond, null);
...
context.put("facturasProcessed", facturasProcessed);
context.put("modifoNotProcessed", modifoNotProcessed);
context.put("facturasNotProcessed", facturasNotProcessed);
